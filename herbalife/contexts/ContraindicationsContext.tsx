...
export const useContraindications = (): ContraindicationsContextType => {
  const context = useContext(ContraindicationsContext);
  if (!context) {
    throw new Error('useContraindications doit être utilisé dans un ContraindicationsProvider');
  }
  return context;
};
